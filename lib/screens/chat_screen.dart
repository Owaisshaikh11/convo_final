          ...
          children: [
            ...
            Expanded(
              child: MessageListView(
                  messageHighlightColor: Colors.amber,
                  onMessageSwiped: (message) {
                    setState(() {
                      chatScreen.quotedMessage = message;
                    });
                  }),
            ),
            _ActionBar(),
          ...
          Expanded(
            child: Padding(
                ...
                child: MessageInput(
                  ...
                  quotedMessage: chatScreen.quotedMessage,
                  ...
                  actions: [
                    InkWell(
                      ...
                      onTap: () {
                        Fluttertoast.showToast(msg: 'Avaliable soon..');
                      },
                    )
                  ],
                )
